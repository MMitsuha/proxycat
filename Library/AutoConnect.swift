...
/// Mihomo, host Swift, and extension Swift logs are retained separately;
/// unrecognized `.log` files are removed, and files currently being
/// written to are always preserved.
